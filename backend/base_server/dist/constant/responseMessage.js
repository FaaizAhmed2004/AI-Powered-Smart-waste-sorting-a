...
exports.default = {
    ...
    NOT_FOUND: (entity) => `${entity} is not found`,
    TOO_MANY_REQUESTS: `So many requests`,
    UNAUTHORIZED: 'You are not allowed to perform this task',
    auth: {
        ALREADY_EXISTS: (entity, identifier) => `${identifier} already exists for the ${entity}`,
        ALREADY_CONFIRMED: (entity) => `${entity} already CONFIRMED`,
