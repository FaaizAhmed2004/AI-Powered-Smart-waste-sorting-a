...
export const SocialAuthButtons = ({ onGoogle, onFacebook, onTwitter, isLoading = false }: SocialAuthButtonsProps) => {
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-4 justify-center">
        <Button
          ...
          disabled={isLoading}
          onClick={onGoogle}
          className="flex-1 border-2 hover:border-green-600 hover:bg-green-50 bg-transparent"
        >
